...
export default function CartPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-4">
      <h1 className="text-2xl font-bold text-[var(--color-text)] mb-6">Sepetim ({items.length} ürün)</h1>
                ...
                <CardContent className="p-4">
                  <div className="flex gap-4">
                    ...
                    <Link
                      ...
                      className="w-20 h-20 sm:w-24 sm:h-24 rounded-lg overflow-hidden shrink-0 bg-[var(--color-surface)]"
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      <Link
                        href={`/urun/${product.slug}`}
                        className="text-sm font-medium text-[var(--color-text)] hover:text-[var(--color-primary)] line-clamp-2 text-left"
                      >
                        {product.name}
                      </Link>
                      {product.brand && (
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <div className="flex items-center gap-3">
                          <div className="text-right">
                            ...
                            <p className="font-bold text-[var(--color-primary)]">{formatPrice(price * item.quantity)}</p>
                          </div>
                          <Button
                            variant="ghost"
                            size="icon"
                            className="h-8 w-8 text-gray-400 hover:text-[var(--color-danger)]"
        ...
        <div>
          <Card className="sticky top-24">
            ...
            <CardContent className="space-y-4">
              ...
              {shipping === 0 && (
                <p className="text-xs text-[var(--color-success)] text-center">🎉 Ücretsiz kargo!</p>
              )}
